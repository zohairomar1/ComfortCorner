...
const generateResponse = (incomingChatLi) => {
    ...
    fetch("/.netlify/functions/chatbot", requestOptions)
        ...
        .then((data) => {
            ...
            if (data.choices && data.choices.length > 0) {
                ...
                messageElement.textContent = "Oops! " + data.error;
            } else {
                messageElement.textContent = "Sorry, I couldn’t understand that. Can you try rephrasing?";
            }
        })
        .catch((error) => {
